...
question_1 = Quiz(
    question={
        "question": "What is the correct code snippet to create a countplot for the GCL feature?",
        "options": [
            "sns.countplot(x='RAC1P', hue='GCL', data=df, palette='husl', dodge=True)",
            "sns.countplot(x=model_target, hue='GCL', data=df, palette='husl', dodge=True)",
